...
import {fetchAllProductsByFiltersAsync, selectAllProducts, selectTotalItems } from '../productSlice';
          ...
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-8">
                <h1 className="text-4xl font-light tracking-tight text-gray-900">All Pets</h1>
      ...
      <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {products && products.map((product) => (
            <Link to={`/pet-detail/${product.id}`} key={product.id} >
              <div className="group relative border-solid border-2 p-1.5 border-gray-200">
